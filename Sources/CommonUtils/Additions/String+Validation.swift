...
@objc public extension NSString {
    ...
    var isValid: Bool { (self as String).isValid }
    
    var isValidEmail: Bool { (self as String).isValidEmail }
}
...
public extension String {
    ...
    var isValid: Bool { trimmingCharacters(in: CharacterSet.whitespacesAndNewlines).count != 0 }
