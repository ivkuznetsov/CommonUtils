...
public extension String {
    ...
    var isValid: Bool { trimmingCharacters(in: .whitespacesAndNewlines).count > 0 }
    
    var isValidEmail: Bool { NSPredicate(format: "SELF MATCHES %@", String.emailRegEx).evaluate(with:lowercased()) }
}
